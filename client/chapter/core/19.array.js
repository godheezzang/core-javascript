...
// 배열 요소 추가
let unshift = friends.unshift('태희'); // ['태희', '경민', '보미', '가희', '재훈', '도희', '남동', '원명', '호재가 효재다~', '진욱'], 0번째로 추가
//unshift 반환값: 10 = 추가된 배열의 length
let push = friends.push('태희'); // 맨 뒤에 추가
// push 반환값: 11


// 배열 요소 제거
let shift = friends.shift(); // ['경민', '보미', '가희', '재훈', '도희', '남동', '원명', '호재가 효재다~', '진욱'], 맨 앞 요소 제거
// shift 반환값: '태희', 제거된 요소의 이름
