...
const value = sum // value에 함수 본문이 담긴다
...
function first(){
    ...
    function second(){ // second는 바깥의 x에 접근 가능: outer environment
        let y = 20;
        return x + y
    }

    return second // 이러면 result에 함수 본문이 담기게 된다. -> result는 함수 실행 가능
...
result(); // 함수 본문을 내뱉었기 때문에 result는 함수 실행이 가능하다.
